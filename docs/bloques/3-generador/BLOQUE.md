...
- **2 · 9 previews:** 3 (impeccable+taste+despensa) + 3 (lapa.ninja estilos) + 3 (GSAP+Three.js, HTML estático).
...
| 3 previews GSAP+3D (7-9) | `frontend-design` + skills GSAP + Three.js CDN (ver `referencias/gsap-skills.md`) |
