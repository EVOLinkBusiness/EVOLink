...
@font-face {
  ...
  src: url("https://framerusercontent.com/assets/2IjwYIiEyi5zJbRRFItKFXRlI.woff2") format("woff2");
  font-weight: 600;
}
@font-face {
  font-family: "Haffer XH Regular";
  src: url("https://framerusercontent.com/assets/YAgYmyrrj1l3cmkK6S9uOWUs.woff2") format("woff2");
  font-weight: 400;
}
@font-face {
  font-family: "Haffer XH Bold";
  src: url("https://framerusercontent.com/assets/boI4aFZH6kEFuh34ef3aytFig.woff2") format("woff2");
  font-weight: 400;
}
@font-face {
  font-family: "Haffer XH Bold Italic";
  src: url("https://framerusercontent.com/assets/5UOWT0VbJoShoSmdn1ggC87v4s.woff2") format("woff2");
  font-weight: 700;
}
@font-face {
  font-family: "Haffer XH Regular Italic";
  src: url("https://framerusercontent.com/assets/ZFW7rf1jJBu97PIBSxjT4Sg1lfk.woff2") format("woff2");
  font-weight: 400;
}
@font-face {
  font-family: "Inter";
