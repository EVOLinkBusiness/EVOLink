...
@font-face {
  ...
  src: url("https://b.stripecdn.com/mkt-ssr-statics/assets/_next/static/media/Sohne.cb178166.woff2") format("woff2");
  font-weight: 1;
}
@font-face {
  font-family: "SourceCodePro";
  src: url("https://b.stripecdn.com/mkt-ssr-statics/assets/_next/static/media/SourceCodePro-Medium.f5ba3e6a.woff2") format("woff2");
  font-weight: 500;
}
```
